...
`endif
	...
	wire [13:0] sub_wire7;
	wire [10:0] sub_wire6 = data5x[10:0];
	wire [10:0] sub_wire5 = data4x[10:0];
	wire [10:0] sub_wire4 = data3x[10:0];
	wire [10:0] sub_wire3 = data2x[10:0];
	wire [10:0] sub_wire2 = data1x[10:0];
	wire [10:0] sub_wire0 = data0x[10:0];
	wire [65:0] sub_wire1 = {sub_wire6, sub_wire5, sub_wire4, sub_wire3, sub_wire2, sub_wire0};
	wire [13:0] result = sub_wire7[13:0];
